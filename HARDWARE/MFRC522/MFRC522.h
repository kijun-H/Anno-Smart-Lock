...
#define MFRC522_CS(x) 	x ? GPIO_SetBits(GPIOE,GPIO_Pin_6) :GPIO_ResetBits(GPIOE,GPIO_Pin_6)
#define MFRC522_Rst(x) 	x ? GPIO_SetBits(GPIOG,GPIO_Pin_15):GPIO_ResetBits(GPIOG,GPIO_Pin_15)
#define MFRC522_MOSI(x) x ? GPIO_SetBits(GPIOC,GPIO_Pin_9) :GPIO_ResetBits(GPIOC,GPIO_Pin_9)
#define MFRC522_SCK(x) 	x ? GPIO_SetBits(GPIOB,GPIO_Pin_6) :GPIO_ResetBits(GPIOB,GPIO_Pin_6)
#define MFRC522_MISO	  GPIO_ReadInputDataBit(GPIOC,GPIO_Pin_7)
